...
Berikut saya lampirkan bukti pembayarannya. Mohon segera diproses. Terima kasih!`
  ...
  return (
    <div className="flex-1 flex flex-col bg-slate-50 dark:bg-slate-950 min-h-screen items-center justify-center p-6 text-center animate-in fade-in duration-300">
      ...
      <div className="w-full max-w-sm bg-white dark:bg-slate-900 rounded-[1.5rem] p-5 shadow-sm border border-slate-100 dark:border-slate-800 mb-8 text-left space-y-4">
      ...
      <div className="space-y-3 w-full max-w-sm">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <button 
            ...
            className="flex items-center justify-center gap-2 bg-white dark:bg-slate-950 text-slate-700 dark:text-slate-200 border border-slate-200/80 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-900 rounded-[1.2rem] py-3.5 font-bold text-sm active:scale-95 transition-all shadow-sm"
          >
            <Home size={18} />
            Ke Beranda
          </button>
