  ...
  return (
    <div className="flex-1 flex flex-col bg-slate-50 dark:bg-slate-950 min-h-screen font-sans animate-in fade-in duration-300">
      ...
      <div className="flex-1 flex flex-col pb-[120px]">
        ...
        {/* Blok Rangkuman */}
        <div className="bg-white dark:bg-slate-900 px-5 pt-8 pb-6 flex flex-col items-center justify-center">
          <div className="w-14 h-14 rounded-full bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 flex items-center justify-center mb-4 border border-blue-100 dark:border-blue-800/50">
                ...
                <div 
                  ...
                  className={`relative overflow-hidden rounded-2xl border-2 transition-all duration-300 ${
                    isPaid 
                      ...
                      : 'bg-white border-slate-100 dark:bg-slate-900 dark:border-slate-800 hover:border-slate-200 dark:hover:border-slate-700 shadow-sm'
                  }`}
                >
                    ...
                    <div>
                      {isPaid ? (
                        ...
                        <button
                          ...
                          className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 disabled:bg-slate-200 disabled:text-slate-400 dark:disabled:bg-slate-800 dark:disabled:text-slate-500 disabled:shadow-none text-white px-5 py-2.5 rounded-xl font-bold text-sm active:scale-95 transition-all shadow-md shadow-blue-600/20"
                        >
                          {!txId ? (
      ...
      {cashInstructionOpen && createPortal(
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6">
          ...
          <div className="bg-slate-50 dark:bg-slate-950 w-full max-w-sm rounded-[1.5rem] shadow-2xl relative z-10 animate-in fade-in zoom-in-95 duration-300 flex flex-col overflow-hidden border border-slate-100 dark:border-slate-800">
            
            {/* Header Dialog */}
            <div className="bg-white dark:bg-slate-900 px-6 py-5 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between shrink-0">
              <div>
            ...
            <div className="p-5 bg-slate-50 dark:bg-slate-950 border-t border-slate-100 dark:border-slate-800 shrink-0">
              <button 
                onClick={() => setCashInstructionOpen(false)} 
                className="w-full h-[48px] bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold text-sm shadow-md shadow-blue-600/20 transition-all active:scale-[0.98]"
              >
                Saya Mengerti
              </button>
            </div>
