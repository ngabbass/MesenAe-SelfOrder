...
export default function TrackingView({ 
  ...
  if (loadingActive) {
    if (liveTx || finalOrderData?.transaction) {
      return (
        <div className="flex-1 flex flex-col bg-slate-50 dark:bg-slate-950 min-h-screen animate-in fade-in duration-300">
          {/* Skeleton Header */}
          ...
          <div className="flex-1 p-5 overflow-y-auto pb-[180px] custom-scrollbar-hide">
            {/* Skeleton Hero Card */}
      ...
      return (
        <div className="flex-1 flex flex-col items-center justify-center p-6 bg-slate-50 dark:bg-slate-950 min-h-screen animate-in fade-in duration-300">
