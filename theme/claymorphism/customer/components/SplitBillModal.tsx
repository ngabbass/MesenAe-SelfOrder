...
export default function SplitBillModal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 sm:p-6">
      ...
      {/* Modal Container */}
      <div className="w-full max-w-md clay-card relative z-10 animate-in fade-in zoom-in-95 duration-300 flex flex-col max-h-[90vh] overflow-hidden">
        
        {/* Header - Fixed di atas */}
        <div className="bg-transparent px-6 py-5 border-b border-slate-100/10 flex items-center justify-between shrink-0">
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-6 custom-scrollbar-hide bg-transparent">
              ...
              {[2, 3, 4].map((num) => {
                ...
                return (
                  <button
                    ...
                    className={`py-3.5 font-bold text-sm transition-all ${
                      isSelected
                        ? 'clay-btn-primary'
                        : 'clay-btn-secondary'
                    }`}
          ...
          <div className="flex items-center justify-between p-4 bg-white/45 dark:bg-slate-900/45 rounded-2xl border border-slate-200/50 dark:border-slate-800/50 shadow-sm">
            <div>
          ...
          {!isBagiRata && (
            <div className="p-5 bg-white/45 dark:bg-slate-900/45 rounded-2xl border border-slate-200/50 dark:border-slate-800/50 shadow-sm space-y-4 animate-in fade-in slide-in-from-top-2">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              {Array.from({ length: localNumPeople }).map((_, idx) => {
                ...
                return (
                  <div key={idx} className="p-4 bg-white/45 dark:bg-slate-900/45 rounded-2xl border border-slate-200/50 dark:border-slate-800/50 space-y-3.5 shadow-sm">
                    <div className="flex items-center justify-between">
                      ...
                      {isBagiRata ? (
                        <span className="font-black text-sm text-slate-900 dark:text-white tracking-wide bg-slate-50/50 dark:bg-slate-800/50 px-3 py-1.5 rounded-lg border border-slate-100/10">
                          {FORMAT_IDR(amount)}
                        </span>
                      ) : (
                        <div className="flex items-center gap-1.5 w-[140px]">
                          ...
                          <input
                            ...
                            className="w-full clay-input px-2.5 py-1.5 text-sm font-black text-right text-blue-700 dark:text-blue-400 transition-colors"
                            placeholder="0"
                          />
                        </div>
                      )}
          ...
          <div className="pt-2 pb-1">
            {(() => {
              ...
              if (diff !== 0) {
                return (
                  <div className="p-3.5 rounded-xl text-[11px] font-bold flex items-center justify-center gap-2 bg-red-50 dark:bg-red-500/10 text-red-600 dark:text-red-400 border border-red-200/50 dark:border-red-900/50 animate-shake">
                    <AlertCircle size={16} />
                    <span>
                      {diff > 0 
              ...
              return (
                <div className="p-3.5 rounded-xl text-[11px] font-bold flex items-center justify-center gap-2 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 border border-blue-200/50 dark:border-blue-850/50">
        ...
        <div className="p-5 border-t border-slate-100/10 bg-transparent shrink-0">
          <button 
            ...
            className="w-full clay-btn-primary disabled:opacity-50 disabled:cursor-not-allowed py-3.5 font-bold text-sm flex justify-center items-center"
          >
            Terapkan Bagian
          </button>
        </div>
