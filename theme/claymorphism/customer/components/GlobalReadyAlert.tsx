...
export default function GlobalReadyAlert({ customerName, storeSettings }: GlobalReadyAlertProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative z-10 w-full max-w-sm overflow-hidden clay-card p-0 border-none"
        onClick={e => e.stopPropagation()}
      >
        {/* Banner biru atas */}
        <div className="bg-gradient-to-br from-blue-600 to-blue-500 p-6 pb-8 text-center relative overflow-hidden">
          {/* Dekorasi */}
        ...
        <div className="p-6 space-y-4">
          ...
          <button
            onClick={handleDismiss}
            className="w-full clay-btn-primary py-3.5 font-bold text-base uppercase"
          >
            Tutup
          </button>
        </div>
