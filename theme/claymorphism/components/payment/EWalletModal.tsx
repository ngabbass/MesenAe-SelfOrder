        ...
        <div className="p-4 overflow-y-auto max-h-[55vh] custom-scrollbar-hide">
          ...
          {step === 'select' && !isManual && (
            <>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0 pr-2">
                      <div className="flex items-center gap-2">
                        <p className="font-bold text-sm text-slate-800 dark:text-slate-200 group-hover:text-blue-500 transition-colors">
                          {wallet.name}
                        </p>
                        {wallet.tag && (
              ...
              <button
                className="w-full text-slate-400 hover:text-slate-600 dark:text-slate-500 dark:hover:text-slate-300 text-xs font-bold uppercase tracking-wider py-2"
                onClick={handleClose}
              >
                Batalkan Transaksi
              </button>
          ...
          {step === 'loading' && (
            <div className="flex flex-col items-center py-8 gap-4">
              <div className="relative flex items-center justify-center">
                ...
                <Loader2 className="w-9 h-9 text-blue-500 animate-spin relative z-10" />
              </div>
          ...
          {step === 'error' && (
            <div className="flex flex-col items-center py-4 gap-3 text-center">
              ...
              <div className="flex gap-2 w-full mt-2">
                <button
                  onClick={() => setStep('select')}
                  className="flex-1 clay-btn-secondary py-2.5 text-xs font-bold uppercase flex items-center justify-center gap-1.5"
                >
                ...
                {selectedWallet && (
                  <button
                    ...
                    className="flex-1 clay-btn-primary py-2.5 text-xs font-bold uppercase flex items-center justify-center gap-1.5"
                  >
