...
Berikut saya lampirkan bukti pembayarannya. Mohon segera diproses. Terima kasih!`
  ...
  return (
    <div className="flex-1 flex flex-col bg-transparent min-h-screen items-center justify-center p-6 text-center animate-in fade-in duration-300">
      ...
      <div className="w-full max-w-sm glass-card rounded-[1.5rem] p-5 shadow-sm border border-white/20 dark:border-white/10 mb-8 text-left space-y-4">
        <div className="flex justify-between items-center">
          ...
          <div className="text-right">
            ...
            <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold ${isLunas ? 'bg-emerald-100 text-emerald-800 dark:bg-emerald-950/30 dark:text-emerald-400' : 'bg-amber-100 text-amber-800 dark:bg-amber-950/30 dark:text-amber-400'}`}>
              {isLunas ? 'Lunas' : 'Belum Lunas'}
            </span>
          </div>
        </div>

        <div className="border-t border-white/20 dark:border-white/10 pt-3 space-y-2 text-xs text-slate-500 dark:text-slate-400">
          ...
          <div className="flex justify-between text-sm font-black text-slate-900 dark:text-white border-t border-white/20 dark:border-white/10 pt-2">
            <span>Total</span>
      ...
      <div className="space-y-3 w-full max-w-sm">
        ...
        {isManualNonCash ? (
          <>
            ...
            <div className="w-full text-center py-2 text-xs font-semibold text-amber-500 flex items-center justify-center gap-1.5 bg-amber-500/5 rounded-xl border border-amber-500/10">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button 
            ...
            className="flex items-center justify-center gap-2 glass-card text-slate-700 dark:text-slate-200 border border-white/20 dark:border-white/10 hover:bg-white/20 dark:hover:bg-white/10 rounded-[1.2rem] py-3.5 font-bold text-sm active:scale-95 transition-all shadow-sm"
          >
            <ChefHat size={18} />
            Lacak Pesanan
          </button>
