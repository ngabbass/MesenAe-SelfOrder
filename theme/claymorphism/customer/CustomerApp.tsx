          ...
          <div className="flex-1 flex flex-col overflow-y-auto bg-transparent relative pb-20">
            ...
            <div className="px-5 relative z-10 mb-5">
              <div 
                ...
                className="clay-card p-4 flex items-center justify-between cursor-pointer hover:border-blue-500/20 hover:scale-[1.01] active:scale-[0.99] transition-all duration-300 group"
              >
                <div className="flex items-center gap-3">
                  <div className="w-[42px] h-[42px] rounded-2xl bg-gradient-to-br from-blue-600 to-blue-500 flex items-center justify-center text-white shadow-sm shrink-0 clay-btn-primary">
                ...
                <div className="w-8 h-8 rounded-full bg-blue-50 dark:bg-blue-950 flex items-center justify-center text-blue-500 group-hover:bg-blue-500 group-hover:text-white shrink-0 transition-all duration-300 shadow-sm">
                      ...
                      {displayOffers.map((_, i) => (
                        <button
                          ...
                          className={`h-1.5 rounded-full transition-all duration-300 ${
                            i === activeDotIndex ? 'w-5 bg-blue-500 shadow-md shadow-blue-500/30' : 'w-1.5 bg-slate-300 dark:bg-slate-700'
                          }`}
            ...
            <div className="px-6 py-2 sticky top-0 z-30 mb-4 bg-transparent">
              <div className="clay-card rounded-[2.25rem] p-1.5 flex items-center justify-between border-none">
                {[
                  ...
                  return (
                    <button
                      key={tab.id}
                      onClick={handleClick}
                      className={`flex-1 py-3 px-2 rounded-[1.75rem] flex items-center justify-center gap-2 font-black text-xs sm:text-sm transition-all duration-300 relative ${
                        isActive
              ...
              <div className="fixed bottom-6 md:bottom-10 left-1/2 -translate-x-1/2 z-40 px-6 w-full max-w-md pointer-events-none flex justify-center animate-in slide-in-from-bottom-8 fade-in duration-300">
                <div className="w-full pointer-events-auto">
                  <button
                    ...
                    className="w-full clay-card p-4 px-6 flex items-center justify-between active:scale-[0.98] transition-all relative overflow-hidden group hover:border-blue-500/30"
                  >
                    ...
                    <div className="flex items-center gap-4 relative z-10">
                      <div className="relative">
                        <div className="clay-btn-primary p-3 shadow-md flex items-center justify-center">
                    ...
                    <div className="relative z-10 flex items-center gap-1 text-xs font-black bg-blue-50 dark:bg-blue-950/40 px-4 py-2.5 rounded-[1.2rem] text-blue-600 dark:text-blue-400 uppercase tracking-widest hover:scale-105 active:scale-95 transition-all">
