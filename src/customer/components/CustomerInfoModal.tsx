...
export default function CustomerInfoModal({
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative w-full max-w-sm bg-white dark:bg-slate-900 rounded-[2rem] shadow-2xl overflow-hidden transform transition-all duration-300 ease-out ${
      ...
      >
        ...
        {!preventClose && (
          <button
            onClick={onClose}
            className="absolute top-4 right-4 z-10 p-2 text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300 bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-full transition-colors"
              ...
              {(() => {
                ...
                return parsedTable.isTakeAway ? (
                  <input
                    ...
                    disabled={true}
                    className="w-full pl-11 pr-4 py-3.5 border rounded-2xl text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 border-slate-200 dark:border-slate-700 font-semibold focus:outline-none transition-all cursor-not-allowed select-none"
                  />
                ) : (
                  <div className="w-full pl-11 pr-4 py-3 border rounded-2xl text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 border-slate-200 dark:border-slate-700 font-semibold flex items-center select-none">
