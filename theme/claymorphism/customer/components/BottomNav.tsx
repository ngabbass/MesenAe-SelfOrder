...
export default function BottomNav({ currentView, setView }: BottomNavProps) {
  ...
  return (
    <div className="fixed bottom-4 left-0 right-0 z-50 px-4 pointer-events-none flex justify-center pb-safe">
      {/* Floating Claymorphism Pill Container */}
      <div className="w-full max-w-md pointer-events-auto clay-card px-3.5 py-2.5 flex justify-between items-center transition-all duration-500 relative border-none">
            ...
            >
              {isActive && (
                <motion.div
                  ...
                  className="absolute inset-0 bg-gradient-to-r from-blue-600 to-blue-500 dark:from-blue-600 dark:to-blue-500 shadow-md shadow-blue-500/20 rounded-full clay-btn-primary p-0 border-none"
