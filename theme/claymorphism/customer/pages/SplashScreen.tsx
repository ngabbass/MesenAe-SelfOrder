  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-white relative overflow-hidden min-h-screen">
      ...
      <motion.div 
        ...
        className="absolute w-[40rem] h-[40rem] bg-gradient-to-tr from-blue-500/10 to-indigo-500/5 rounded-full blur-[100px] -top-32 -right-32 pointer-events-none" 
      />
      <motion.div 
        initial={{ opacity: 0, scale: 0.8 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 2, ease: "easeOut", delay: 0.2 }}
        className="absolute w-[30rem] h-[30rem] bg-gradient-to-bl from-blue-400/5 to-transparent rounded-full blur-[80px] bottom-10 -left-20 pointer-events-none" 
      />
      
      {/* Main Content */}
      <div className="relative z-10 flex flex-col items-center">
        
        {/* Premium Clay Logo Container */}
        <motion.div 
          initial={{ y: 20, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
          className="clay-card p-7 mb-8 relative overflow-hidden flex items-center justify-center border-none shadow-xl shadow-blue-500/5"
        >
          <div 
            className="absolute inset-0 bg-gradient-to-br from-blue-400/10 to-indigo-500/10 opacity-50" 
          />
          {storeSettings?.logo ? (
            <motion.img 
            ...
            <motion.div 
              ...
              animate={{ scale: 1, opacity: 1 }}
              transition={{ duration: 0.5, delay: 0.3 }}
              className="w-20 h-20 bg-gradient-to-br from-blue-600 to-blue-500 rounded-2xl flex items-center justify-center shadow-inner relative z-10 clay-btn-primary p-0 border-none"
            >
