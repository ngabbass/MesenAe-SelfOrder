        ...
        {isMainView && (
          <div className="flex-1 flex flex-col overflow-y-auto bg-transparent relative pb-20">
            ...
            <div className="px-5 pt-4 pb-3 relative z-10">
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    {isDarkMode ? (
                      <Sun size={20} className="text-black" strokeWidth={3} />
                    ) : (
                      <Moon size={20} className="text-black" strokeWidth={3} />
                    )}
                  </button>
                </div>
              </div>
                      ...
                      {displayOffers.map((_, i) => (
                        <button
                          ...
                          className={`h-1.5 rounded-full transition-all duration-300 ${
                            i === activeDotIndex ? 'w-5 bg-[#ffc700] border border-black' : 'w-1.5 bg-slate-300 dark:bg-slate-700'
                          }`}
            ...
            <div className="px-6 py-2 sticky top-0 z-30 mb-4 bg-transparent">
              <div className="glass-panel-heavy rounded-[2rem] p-1.5 flex items-center justify-between bg-white dark:bg-slate-900">
                {[
                  ...
                  return (
                    <button
                      key={tab.id}
                      onClick={handleClick}
                      className={`flex-1 py-2.5 px-2 rounded-[1.8rem] flex items-center justify-center gap-2 font-black text-xs sm:text-sm transition-all duration-200 relative ${
                        isActive
                          ? 'bg-[#ffc700] text-black border-2 border-black dark:border-slate-700 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:shadow-[2px_2px_0px_0px_#374151] scale-[1.02]'
              ...
              <div className="fixed bottom-6 md:bottom-10 left-1/2 -translate-x-1/2 z-40 px-6 w-full max-w-md pointer-events-none flex justify-center animate-in slide-in-from-bottom-8 fade-in duration-300">
                <div className="w-full pointer-events-auto">
                  <button
                    ...
                    className="w-full bg-white dark:bg-slate-900 border-3 border-black dark:border-slate-700 p-4 px-6 shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] dark:shadow-[5px_5px_0px_0px_#374151] flex items-center justify-between active:translate-x-[1.5px] active:translate-y-[1.5px] active:shadow-none transition-all relative overflow-hidden group"
                  >
                    <div className="flex items-center gap-4 relative z-10">
                      <div className="relative">
                        <div className="bg-[#ffc700] text-black p-3 border-2 border-black dark:border-slate-700 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:shadow-[2px_2px_0px_0px_#374151]">
                          <ShoppingBag size={20} strokeWidth={3} />
                        </div>
                        <span className="absolute -top-1.5 -right-1.5 bg-rose-500 text-white text-[10px] min-w-[22px] h-[22px] px-1 flex items-center justify-center rounded-none font-black border-2 border-black dark:border-slate-700 shadow-[1.5px_1.5px_0px_0px_rgba(0,0,0,1)] dark:shadow-[1.5px_1.5px_0px_0px_#374151]">
                          {cart.reduce((a: number, b: CartItem) => a + b.qty, 0)}
                        </span>
                      </div>
                      <div className="text-left">
                        <p className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-0.5">Keranjang Belanja</p>
                        <p className="font-black text-lg leading-none text-black dark:text-white">{FORMAT_IDR(cartTotal.total)}</p>
                      </div>
                    </div>
                    <div className="relative z-10 flex items-center gap-1 text-xs font-black bg-[#ffc700] hover:bg-[#ffe066] border-2 border-black dark:border-slate-700 px-4 py-2.5 text-black uppercase tracking-widest active:translate-x-[1px] active:translate-y-[1px] transition-all shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:shadow-[2px_2px_0px_0px_#374151]">
