...
export default function PaymentModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      ...
      {/* Container Dialog */}
      <div className="bg-slate-50 dark:bg-slate-950 w-full max-w-md rounded-[1.5rem] shadow-2xl relative z-10 animate-in fade-in zoom-in-95 duration-300 flex flex-col max-h-[85vh] overflow-hidden border border-slate-100 dark:border-slate-800">
        ...
        <div className="bg-white dark:bg-slate-900 px-6 py-5 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between sticky top-0 z-20 shrink-0">
          ...
          <button 
            onClick={onClose}
            disabled={processing}
            className="w-8 h-8 rounded-full bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 flex items-center justify-center text-slate-500 transition-colors shrink-0 disabled:opacity-50"
          >
            <X size={18} />
          </button>
        </div>
        ...
        <div className="p-5 border-t border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 shrink-0">
          <button 
            onClick={onConfirm}
            disabled={processing}
