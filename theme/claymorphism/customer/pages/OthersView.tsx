...
export default function OthersView({ 
  ...
  return (
    <div className={isEmbedded ? "space-y-4 animate-in fade-in duration-300 pb-4 px-2" : "flex-1 flex flex-col bg-transparent pb-24 overflow-y-auto animate-in fade-in duration-300 px-4 pt-6"}>
      ...
      {/* Profil Header Card - Redesigned Soft Blue Theme */}
      <div className="pb-2">
        <div className="relative clay-card p-6 overflow-hidden">
          {/* Decorative glowing background patterns */}
          <div className="absolute top-[-40%] right-[-20%] w-56 h-56 bg-blue-500/5 dark:bg-blue-500/10 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute bottom-[-30%] left-[-10%] w-40 h-40 bg-blue-500/5 dark:bg-blue-500/10 rounded-full blur-3xl pointer-events-none" />

          <div className="flex items-center gap-4 relative z-10">
            {/* Beautiful Profile Avatar with blue border */}
            <div className="w-16 h-16 bg-blue-500/10 dark:bg-blue-500/20 backdrop-blur-md rounded-full flex items-center justify-center text-blue-500 dark:text-blue-400 shrink-0 border border-blue-100 dark:border-blue-900/40 shadow-sm">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                <h1 
                  ...
                  className="font-extrabold text-xl sm:text-2xl text-slate-900 dark:text-white leading-tight truncate cursor-pointer hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                ...
                <button 
                  onClick={openEditModal}
                  className="p-1 text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors shrink-0"
                  title="Ubah Nama/Nomor"
                >
                  <Edit2 size={16} />
                </button>
              ...
              <div className="flex items-center gap-1.5 mt-2.5 text-slate-600 dark:text-slate-300 text-xs font-medium">
                {(() => {
                  ...
                  return parsed.isTakeAway ? (
                    <span className="inline-flex items-center gap-1 bg-slate-100/50 dark:bg-slate-800/50 border border-slate-200/25 dark:border-slate-700/25 text-slate-700 dark:text-slate-300 text-[9px] sm:text-[10px] font-extrabold px-3 py-1.5 rounded-xl shadow-inner uppercase tracking-wide">
                      Take Away (Bawa Pulang)
                    </span>
                  ) : (
                    <div className="flex items-center gap-1.5">
                      <span className="inline-flex items-center gap-1 bg-slate-100/50 dark:bg-slate-800/50 border border-slate-200/25 dark:border-slate-700/25 text-slate-700 dark:text-slate-300 text-[9px] sm:text-[10px] font-extrabold px-3 py-1.5 rounded-xl shadow-inner tracking-wide uppercase leading-none">
                        <span className="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse"></span>
                        {parsed.area}
                      </span>
                      <span className="inline-flex items-center bg-blue-600 text-white text-[9px] sm:text-[10px] font-black px-3.5 py-1.5 rounded-xl shadow-md tracking-wide uppercase leading-none">
      ...
      <div className="px-4 space-y-5">
        ...
        <div>
          ...
          <div className="clay-card overflow-hidden !rounded-[2rem] !p-0">
            
            {/* Riwayat Pesanan */}
            <button 
              onClick={() => setView('history')} 
              className="w-full p-4 flex items-center justify-between hover:bg-blue-500/5 dark:hover:bg-blue-500/10 transition-all duration-200 group"
            >
            ...
            <div className="h-[1px] bg-slate-100/10 dark:bg-slate-800/10 mx-4" />
            ...
            >
              ...
              <div className="flex items-center gap-2">
                {activeVouchers.length > 0 && (
                  <span className="bg-blue-500/10 text-blue-500 dark:bg-blue-500/20 dark:text-blue-400 text-[10px] font-bold px-2 py-0.5 rounded-full">
        ...
        <div>
          ...
          <div className="clay-card overflow-hidden !rounded-[2rem] !p-0">
            ...
            >
              ...
              <ChevronRight size={18} className={`text-slate-400 transition-all duration-300 group-hover:translate-x-1 ${showCS ? 'rotate-90 text-blue-500' : ''}`} />
            </button>
            
            {/* CS Options Dropdown */}
            {showCS && (
              <div className="px-4 pb-5 pt-2 bg-slate-50/50 dark:bg-slate-800/10 space-y-3 animate-in slide-in-from-top-2 duration-300 border-t border-slate-100/10 dark:border-slate-800/10">
                
                {/* Opsi 1: Bantuan Kasir */}
                <button 
                  onClick={() => openWhatsApp(activeKasirWa, orderMessageTemplate)} 
                  className="w-full flex items-center gap-4 clay-card !rounded-2xl hover:bg-blue-500/5 transition-all group"
                >
                  ...
                  <div className="text-left flex-1">
                    <h4 className="font-semibold text-sm text-slate-800 dark:text-slate-100 group-hover:text-blue-500 transition-colors">Bantuan Pesanan</h4>
                ...
                >
                  ...
                  <div className="text-left flex-1">
                    <h4 className="font-semibold text-sm text-slate-800 dark:text-slate-100 group-hover:text-blue-500 transition-colors">Bantuan Teknis</h4>
      ...
      {showVouchers && createPortal(
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative clay-card w-full max-w-sm p-6 flex flex-col max-h-[85vh] animate-in zoom-in-95 duration-200">
            
            <button 
              onClick={() => setShowVouchers(false)} 
              className="absolute top-4 right-4 p-2.5 clay-btn-secondary text-slate-500 hover:text-blue-500 rounded-full transition-colors z-10"
            >
              <X size={18} strokeWidth={2.5} />
            </button>
            
            <div className="text-center mb-6 pt-2">
              <div className="w-16 h-16 bg-blue-500/10 rounded-full flex items-center justify-center mx-auto mb-4 text-blue-500 shadow-inner">
            ...
            <div className="flex-1 overflow-y-auto space-y-4 pr-1 custom-scrollbar-hide" style={{ scrollbarWidth: 'none' }}>
              {activeVouchers.length === 0 ? (
                ...
                activeVouchers.map((v: Voucher) => (
                  <div key={v.id} className="clay-card !rounded-2xl !p-0 flex overflow-hidden min-h-[96px] relative">
                    
                    {/* Left Side (Gradient badge matching theme color) */}
                    <div className="w-24 bg-gradient-to-br from-blue-500 to-blue-600 text-white p-3 flex flex-col items-center justify-center shrink-0 text-center">
                    ...
                    <div className="absolute top-0 bottom-0 left-[96px] border-l-2 border-dashed border-slate-200/30 dark:border-slate-700/30 z-10" />
                    <div className="absolute -top-2 left-[88px] w-4 h-4 bg-white dark:bg-slate-900 rounded-full border border-slate-200/30 dark:border-slate-800/30 z-10" />
                    <div className="absolute -bottom-2 left-[88px] w-4 h-4 bg-white dark:bg-slate-900 rounded-full border border-slate-200/30 dark:border-slate-800/30 z-10" />

                    {/* Right Side (Details & Copy Button) */}
                    <div className="flex-1 p-3.5 pl-6 flex flex-col justify-between min-w-0">
                      <div className="min-w-0">
                        <span className="text-[9px] font-extrabold text-blue-600 bg-blue-500/10 px-2 py-0.5 rounded-md inline-block mb-1">
                          Kupon Aktif
                        </span>
                      ...
                      <div className="flex items-center justify-between mt-2 gap-2">
                        ...
                        <button 
                          ...
                          className="flex items-center gap-1 clay-btn-primary text-[10px] font-bold px-3 py-2 shadow-sm shrink-0"
                        >
                          <Scissors size={10} />
                          Salin
                        </button>
      ...
      {isEditOpen && createPortal(
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative clay-card w-full max-w-sm p-6 flex flex-col animate-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleEditSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3.5 clay-input text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 outline-none focus:ring-2 focus:ring-blue-500/20 transition-all"
                    required
                  />
                </div>
              </div>
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full clay-btn-primary py-3.5 font-bold uppercase tracking-wider text-xs"
                >
                  Simpan Perubahan
                </button>
              </div>
