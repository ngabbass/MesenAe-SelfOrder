...
export default function OthersView({ 
  ...
  return (
    <div className="flex-1 flex flex-col bg-slate-50 dark:bg-slate-950 pb-[180px] overflow-y-auto animate-in fade-in duration-300">
      
      {/* Profil Header Card - Redesigned Light/Professional Theme */}
      <div className="px-4 pt-6 pb-2">
        <div className="relative bg-white dark:bg-slate-900 text-slate-900 dark:text-white rounded-[2rem] p-6 shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
          ...
          <div className="absolute bottom-[-30%] left-[-10%] w-40 h-40 bg-purple-500/5 dark:bg-purple-500/10 rounded-full blur-3xl pointer-events-none" />

          <div className="flex items-center gap-4 relative z-10">
            {/* Beautiful Profile Avatar with glassmorphism border */}
            <div className="w-16 h-16 bg-blue-50 dark:bg-blue-900/20 backdrop-blur-md rounded-full flex items-center justify-center text-blue-600 dark:text-blue-400 shrink-0 border border-blue-100 dark:border-blue-800/50 shadow-sm">
                ...
                {(() => {
                  ...
                  return parsed.isTakeAway ? (
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="inline-flex items-center bg-blue-600 border border-blue-500 text-white text-[9px] sm:text-[10px] font-black px-3.5 py-1.5 rounded-xl shadow-md tracking-wide uppercase leading-none">
      ...
      <div className="px-4 space-y-5">
        ...
        {/* Group 1: Aktivitas */}
        <div>
          <h3 className="px-4 text-[11px] font-bold uppercase tracking-widest text-slate-400 mb-2 mt-4">Aktivitas Saya</h3>
          <div className="bg-white dark:bg-slate-900 rounded-[1.5rem] border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden">
            ...
            <button 
              ...
              className="w-full p-4 flex items-center justify-between hover:bg-slate-50 dark:hover:bg-slate-800/50 active:bg-slate-100 transition-all duration-200 group"
            >
              <div className="flex items-center gap-3.5">
                <div className="bg-blue-50 dark:bg-blue-500/10 p-2.5 rounded-xl text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform">
            ...
            >
              <div className="flex items-center gap-3.5">
                <div className="bg-orange-50 dark:bg-orange-500/10 p-2.5 rounded-xl text-orange-600 dark:text-orange-400 group-hover:scale-110 transition-transform">
        ...
        <div>
          ...
          <div className="bg-white dark:bg-slate-900 rounded-[1.5rem] border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden">
            ...
            >
              <div className="flex items-center gap-3.5">
                <div className="bg-emerald-50 dark:bg-emerald-500/10 p-2.5 rounded-xl text-emerald-600 dark:text-emerald-400 group-hover:scale-110 transition-transform">
              ...
              <ChevronRight size={18} className={`text-slate-400 transition-all duration-300 group-hover:translate-x-1 ${showCS ? 'rotate-90' : ''}`} />
            </button>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white dark:bg-slate-900 w-full max-w-sm rounded-[2rem] p-6 shadow-2xl border border-slate-100 dark:border-slate-800 flex flex-col max-h-[85vh] animate-in zoom-in-95 duration-200">
            ...
            <div className="text-center mb-6 pt-2">
              <div className="w-16 h-16 bg-blue-50 dark:bg-blue-900/10 rounded-full flex items-center justify-center mx-auto mb-4 text-primary shadow-inner">
              ...
              {activeVouchers.length === 0 ? (
                ...
                activeVouchers.map((v: Voucher) => (
                  <div key={v.id} className="relative bg-white dark:bg-slate-800 border border-slate-200/60 dark:border-slate-700/60 rounded-2xl shadow-sm hover:shadow-md transition-all flex overflow-hidden min-h-[96px]">
                    ...
                    <div className="w-24 bg-gradient-to-br from-primary to-primary/80 text-white p-3 flex flex-col items-center justify-center shrink-0 text-center">
                    ...
                    <div className="flex-1 p-3.5 pl-6 flex flex-col justify-between min-w-0">
                      <div className="min-w-0">
                        <span className="text-[9px] font-extrabold text-primary bg-primary/10 px-2 py-0.5 rounded-md inline-block mb-1">
                          Kupon Aktif
                        </span>
                      ...
                      <div className="flex items-center justify-between mt-2 gap-2">
                        ...
                        <button 
                          ...
                          className="flex items-center gap-1 bg-primary hover:bg-primary/95 text-white text-[10px] font-bold px-3 py-2 rounded-xl active:scale-95 transition-all shadow-sm shrink-0"
                        >
                          <Scissors size={10} />
                          Salin
                        </button>
      ...
      {isEditOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white dark:bg-slate-900 w-full max-w-sm rounded-[2rem] p-6 shadow-2xl border border-slate-100 dark:border-slate-800 flex flex-col animate-in zoom-in-95 duration-200">
            ...
            <div className="text-center mb-6 pt-2">
              <div className="w-16 h-16 bg-blue-50 dark:bg-blue-500/10 rounded-full flex items-center justify-center mx-auto mb-4 text-blue-600 shadow-inner">
