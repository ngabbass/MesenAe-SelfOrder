    ...
    <div className="flex-1 flex flex-col bg-slate-50 dark:bg-slate-950 min-h-screen font-sans animate-in fade-in duration-300">
      ...
      <div className="flex-1 flex flex-col pb-6">
        ...
        {storeSettings?.enableSplitBill !== false && (
          <>
            <div className="bg-white dark:bg-slate-900 p-5 flex items-center justify-between">
              <div className="flex items-center gap-3.5">
        ...
        {!splitConfig?.active && (
          <>
            <div 
              className="bg-white dark:bg-slate-900 p-5 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors flex items-center justify-between" 
