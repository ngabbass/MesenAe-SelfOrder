...
export default function SplitBillModal({
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 sm:p-6">
      ...
      {/* Modal Container */}
      <div className="bg-slate-50 dark:bg-slate-950 w-full max-w-md rounded-[1.5rem] shadow-2xl relative z-10 animate-in fade-in zoom-in-95 duration-300 flex flex-col max-h-[90vh] overflow-hidden border border-slate-100 dark:border-slate-800">
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-6 custom-scrollbar-hide bg-slate-50 dark:bg-slate-950">
          ...
          {!isBagiRata && (
            <div className="p-5 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-4 animate-in fade-in slide-in-from-top-2">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              {Array.from({ length: localNumPeople }).map((_, idx) => {
                ...
                return (
                  <div key={idx} className="p-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 space-y-3.5 shadow-sm">
                    <div className="flex items-center justify-between">
                      ...
                      {isBagiRata ? (
                        <span className="font-black text-sm text-slate-900 dark:text-white tracking-wide bg-slate-50 dark:bg-slate-800 px-3 py-1.5 rounded-lg border border-slate-100 dark:border-slate-700">
                          {FORMAT_IDR(amount)}
                        </span>
                      ) : (
