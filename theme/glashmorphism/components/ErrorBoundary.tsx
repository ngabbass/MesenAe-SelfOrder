          ...
          <div className="w-full max-w-5xl bg-slate-900 border border-red-900/40 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-5 md:p-6 bg-slate-900 space-y-6 overflow-y-auto flex-1 custom-scrollbar">
              ...
              <div className="space-y-2">
                ...
                <div className="bg-red-950/20 border-l-4 border-l-red-500 border-y border-r border-y-red-900/30 border-r-red-900/30 rounded-r-lg p-4 font-mono text-sm md:text-base font-bold text-red-400 break-words select-text">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-black/80 border border-slate-700 rounded-xl p-5 overflow-x-auto relative select-text">
                  <pre className="text-[11px] leading-relaxed font-mono text-slate-300 whitespace-pre-wrap select-text">
