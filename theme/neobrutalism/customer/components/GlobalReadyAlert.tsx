...
export default function GlobalReadyAlert({ customerName, storeSettings }: GlobalReadyAlertProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative z-10 w-full max-w-sm bg-white dark:bg-slate-900 rounded-[2rem] overflow-hidden shadow-2xl shadow-black/40 animate-in zoom-in-90 duration-300"
