...
export function OtherPaymentModal({
  ...
  return (
    <Dialog open={dialogOpen} onOpenChange={(open) => !open && handleClose()}>
      <DialogContent className="max-w-[95vw] sm:max-w-sm p-0 overflow-hidden clay-card">
        {/* ── Header ── */}
        <div className="bg-gradient-to-br from-blue-600 to-blue-500 p-5 text-white">
          <DialogHeader>
            <DialogTitle className="text-white text-lg font-bold flex items-center gap-2">
              <img src="/ico/ewallet.svg" alt="Digital Wallet" className="w-auto h-5 object-contain rounded bg-white px-1" />
